...
@Service
public class DatabaseOptionServiceImpl implements DatabaseOptionService {

  private final DatabaseOptionRepository databaseOptionRepository;

  public DatabaseOptionServiceImpl(DatabaseOptionRepository databaseOptionRepository) {
